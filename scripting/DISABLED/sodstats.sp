...
public OnPluginStart()
{
	...
	{
		LogError("[KIWI-Rank] Unable to connect to database (%s)", error);
		return;
	}
	...
	{
		LogError("[KIWI-Rank] Invalid DB-Type");
		return;
	}
	...
	{
		LogError("[KIWI-Rank] Could not create players table.");
		return;
	}
	...
	{
		LogError("[KIWI-Rank] Unable to hook events.");
		return;
	}
	...
	{
		LogError("[KIWI-Rank] Could not create stats_enabled cvar.");
		return;
	}
...
{
	if(hndl == INVALID_HANDLE)
		LogError("[KIWI-Rank] Error saving player (%s)", error);
}
